...
# A variável "Links" vai realizar um looping entre as 4 páginas e salvar a url de cada pneu em uma lista
links <-urls %>% 
  map(read_html) %>% 
...
# A variável bases_pneus_store irá armazenar os dados de todos os produtos disponíveis por página
